...
export function Nav() {
  return (
    <header class="nav">
      ...
      <a class="license-link" href={`${import.meta.env.BASE_URL}THIRD_PARTY_LICENSES.txt`} target="_blank" rel="noopener" aria-label="third-party licenses" title="third-party licenses">
        <svg viewBox="0 0 24 24" aria-hidden="true">
